...
public class StartHere {
		 ...
		 * Q2 hint: consider an if statement that > 26 then subtract 26
		 * example z + 2 is 26 + 2 = 28 crash
		 * so if (>26) do result - 26 that is 28 - 26 = 2 = b
		 */
