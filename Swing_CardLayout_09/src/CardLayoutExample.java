...
public class CardLayoutExample implements ActionListener, TeamWork {

	private JButton previousButton, firstButton, lastButton, nextButton;
	...
	public void createAndShowGUI() {
		...
		JFrame frame = new JFrame("CardLayout Experiments!");
	...
	private JPanel createContentPane() {
		...
		JPanel greenPanel_2 = createSquareJPanel(Color.green, 50);
		greenPanel_2.setAlignmentY(Component.BOTTOM_ALIGNMENT);
		...
		JPanel greenPanel_3 = createSquareJPanel(Color.green, 50);
		greenPanel_3.setAlignmentY(Component.TOP_ALIGNMENT);
		...
		cardDescription[0] = "The Center of both squares are aligned";
		cardDescription[1] = "The bottom of the first square is aligned with the center of the second";
		cardDescription[2] = "The top of the first square is aligned with the center of the second";

		cardPanel.add(align_1, cardNames[0]);
		cardPanel.add(align_2, cardNames[1]);
		cardPanel.add(align_3, cardNames[2]);

		// Now we've completed all that, we add our tool bar to the content pane
		// along with this cardPanel panel.
		// We will use a BorderLayout this time to position the tool bar above
		// the CardPanels and the title bar below.
	...
	public void actionPerformed(ActionEvent e) {
		...
		//determine which of the 4 buttons was clicked, then use the handler for that button
